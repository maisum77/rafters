...
const Loader = () => {
  const loaderCss = `
    .loader {
      --duration: 3s;
      /* Brand palette: ink boxes with ember-lavender faces on cream */
      --primary: #231f2c;
      --primary-light: #9f86e0;
      --primary-rgba: rgba(35, 31, 44, 0);
      width: 200px;
      height: 320px;
      position: relative;
      perspective: 1000px;
    ...
    .loader:before, .loader:after {
      ...
      right: 32%;
      bottom: -11px;
      /* Must match the preloader overlay background (cream) for a seamless mask */
      background: #f4f1ea;
